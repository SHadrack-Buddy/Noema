# First, ensure the Logo1.png is in the root directory
Copy-Item "c:\Users\Shadrack\Desktop\Tourism Website 4.0\Home-Page\Logo1.png" "c:\Users\Shadrack\Desktop\Tourism Website 4.0\Logo1.png" -Force
